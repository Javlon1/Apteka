...
import AddProduct from '@/app/components/screens/Admin/AddProduct/AddProduct';
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:title" content="Tovar qo'shish" /> // Название страницы
                ...
                <title>Admin - Tovar qo'shish</title>
            </Head>
            <AddProduct />
        </>
    )
