...
import ChakanaSavdo from '@/app/components/screens/Admin/ChakanaSavdo/ChakanaSavdo';
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:title" content="Chakana Savdo" /> // Название страницы
                ...
                <title>Admin - Chakana Savdo</title>
            </Head>
            <ChakanaSavdo />
        </>
    )
